...
SYSTEM_PROMPT = (
    "你是一位服务硬件工程师读者的中文技术编辑。读者画像：有 4 年开关电源"
    "维修测试实战经验，正在系统学习开关电源设计（PFC/LLC/AHB/flyback 拓扑）。"
...
### 💡 对我有利之处
以上述工程师画像（4 年开关电源维修测试经验、正在系统学习电源设计）的视角，用无序列表写 2-4 条这些趋势/项目对他学习电源设计、维修接单、做技术内容的具体好处。"""
